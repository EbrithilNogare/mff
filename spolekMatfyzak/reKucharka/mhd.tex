...
Výhodné je používání aplikací pro chytré telefony, kterých existuje velké množství, volba je teda na vás. (Idos, PID Lítačka nebo Google maps)
...
Prodávají se v centrále DPP Na Bojišti, další prodejní místa naleznete na \url{www.dpp.cz/prodejni-mista-jizdnich-dokladu/}.
...
Tramvaje jsou ideální pro poskakování po městě. Rychlost závisí
...
sledovat \url{dpp.cz}, kde je téměř vždy napsáno, k jakým čachrům zase došlo. Výluky
...
které po Praze dneska jezdí, a některé vybrané rychlíky. 
...
několik přívozů spadajících pod PID. Pro Matfyzáky je výhodný přívoz P7 z Holešovic do Karlína, který vás významně pžiblíží budově v Karlíně. Důležitý přívoz je P8, který slouží místo zhroucené Trojské lávky. Přívozy nejsou v provozu přes zimu a nevyplují ani v případě
zvýšené povodňové aktivity. 
...
Přestupních bodů je však více. Interval mezi tramvajemi
...
\subsubsubsection{Sdílené dopravní prostředky}
Poslední dobou se v Praze hodně rozšiřuje používání sdílených dopravních prostředků jako jsou kola nebo koloběžky. Nejpoužívanější službou je \textit{Rekola}, která má všechno růžové a nabízí k půjčení kola (včetně elektrokol). Další elektrokola (tentokrát žlutá) si můžete půjčit od společnosti \textit{Freebike}. Elektrické koloběžky k pronájmu nabízí společnost \textit{Lime}.


Výhodou sdíleného způsobu cestování je, že většinou máte prostředek dostupný v dochozí vzdálenosti a nemusíte řešit, kde parkovat. Prostě dojedete do cílové destinace, kde zaparkujete u stojanu nebo třeba u lampy. Rovněž to v centru často vychází výrazně rychleji než používání MHD. Jen pozor na fakt, že né všechny prostředky lze parkovat na všech místech.


Půjčování funguje pomocí speciálních mobilních aplikací, která každá služba nabízí. Cena se hodně liší, většinou se účtuje podle počtu minut, případně lze zakoupit předplatné.
...
Taky je možné využít kolo: 
Lidé, kterým nevadí jízda v hustém provozu, můžou jet od koleje rovně po Magistrále na
Nábřeží Kapitána Jaroše a pak podél řeky. Čas cesty lze tímto způsobem
stáhnout i na 15 minut.
Nebo se můžete vydat po cyklostezce směrem k zoo, přívozem namísto Trojské lávky (frekvence 10 min),
projedete do Stromovky a nahoru do Letenského parku. Nakonec sjedete
