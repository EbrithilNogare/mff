...
Kolejní rada každý rok střídavě pořádá doplňující a řádné volby.
Ty se konají již v říjnu, máš-li tedy pocit, že by ses rád zapojil do
zkvalitnění života na koleji, nezapomeň včas podat kandidaturu.


\subsubsection{Zamlouvání pokojů}
Do roku 2018 (kdy bylo nutno přistoupit k obnově systému) to fungovalo přes Internet někdy v srpnu.
Od té doby zámluvy probíhají přes email kolem poloviny prázdnin s ubytovací kanceláří.

Pokoje na východní straně mizí s překvapivou rychlostí a vězte,
že brzy je již téměř každá buňka na této straně obsazena alespoň jedním člověkem. 

Celé se to netýká studentů, kteří na koleji bydlí i přes prázdniny, neboť ti si
