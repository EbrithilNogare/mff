...
\textbf{Every lab has a printer, the black and white printing costs 1 CZK for one A4, the colour printing from 5 to 15 CZK.} Not all of the printers are able to print in colour.
...
It often happens that the computer lab is closed and in the same time your roommate needs the room to spend some joyful time with his girlfriend. Sometimes it collides with the times you actually need to work.
...
However, you will need to make the registration some time during the day -- it costs 50 CZK per year.