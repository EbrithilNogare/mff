...
However, you will find here many recipes describing how to survive studying at Matfyz (which is in Czech short form for ``the Faculty of Mathematics and Physics'').
...
The first Student Cookbook in Czech was created in 1994 thanks to Martin Krynický (the 1998 version is available here).
