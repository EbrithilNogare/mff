...
All of the information about timetables, fares and so on can be found on the website of the Prague Public Transit \url{dpp.cz/en}.
...
You can buy them at the Main Control Centre at Na bojišti 5, Prague 2 or at another sales locations \url{www.dpp.cz/en/?l=1&p=prodejni-mista-jizdnich-dokladu}.

It is possible to use your student discount while buying time tickets all year round (including holidays). The only exception is that if you buy a time ticket at the end of the academic year (or at the beginning of a new one), you will have to show a new student confirmation of study.
...
We usually use metro, tram, bus, funicular, ferry, train, bike or kick scooter to get around Prague. If we have a valid time ticket, we do not even need to pay any penalties.

\subsubsubsection{Metro}
Metro is the most important part of the whole system. It is opened from 5 a.m. until midnight, or more precisely a bit later as midnight is the time the last trains set out from the terminal station.
...
Every line has its regular route which unfortunately often changes due to traffic closures so you need to frequently check \url{dpp.cz/en} where you can find everything about the current traffic situation.
...
For example travelling by the night line from Jižák to the student residence 17. listopadu is much faster than if you would travel during the daytime.
...
Your route from the dormitory will take you via Nádraží Holešovice most of the times and there are two ways to get there so you may use the following substitution: B 201
